...
_DEFAULT_ROW_HEIGHT = 16             # single-line height; multi-line cells expand via wrap_text + manual user expand
...
def write_ftm_xlsx(
    ...
    *,
    ...
    # is preserved in the cell — visible in the formula bar on click,
    # rendered fully when the user manually expands the row, or shown
    # for every row at once via Excel Alt+H+O+A / Sheets Format > Row
    # > Auto-fit. Default row stays compact to match Oren's Sheets
