...
| Total Financing (all loans) | $8,080 |
| Holding (4 months) | $3,778 |
| Buying costs | $2,098 |
| Selling costs (5% realtor + fees) | $17,311 |
| **Total Non-Rehab Costs** | **$31,267** |
| **Net Profit** | **$31,734** |
| **Total Costs ROI** | **13.6%** |
| **Cash on Cash Return** | **Depends on financing structure** |

### Multi-Loan Financing Structure

The deal analyzer supports up to three loan positions. This allows modeling real-world scenarios like hard money + gap funding, conventional + private money, or any combination.

**Default (when user doesn't specify):** Single first mortgage at hard money terms.

| Loan Position | Default Amount | Default Rate | Default Points |
|--------------|---------------|-------------|----------------|
| First Mortgage | Purchase + Rehab (100% LTV) | 12% annual | 0% |
| Second / Gap Fund | $0 (only if user specifies) | User-specified | User-specified |
| Misc Mortgage | $0 (only if user specifies) | User-specified | User-specified |

**Financing Calculation (per loan):**
```
Monthly Interest = Loan Amount × (Annual Rate / 12)
Points Cost = Loan Amount × Points %
Loan Total Cost = (Monthly Interest × Hold Time) + Points Cost

Total All Financing = First Mortgage Cost + Second Mortgage Cost + Misc Mortgage Cost
```

**Single-loan example**: $202,000 × (12% / 12) = $2,020/month × 4 months + $0 points = $8,080

**Multi-loan example**:
- First mortgage: $155,000 × 80% = $124,000 at 10%, 2 pts → $1,033/mo × 4 = $4,133 + $2,480 pts = $6,613
- Gap fund: $31,000 + $47,000 = $78,000 at 12%, 0 pts → $780/mo × 4 = $3,120
- Total all financing: $9,733
...
| Other/Misc | $53 | Lawn, security, misc |
| **Total monthly** | **$945** | |
...
| Misc | $0 | Other closing costs if applicable |
| **Total buying** | **$2,098** | |
...
| Staging | $0 | Optional for full rehab flips |
| CAT Tax | $0 | Where applicable |
| **Total selling** | **$17,311** | |

### Capital Analysis & ROI Metrics

These metrics show the investor's real exposure and return on their own money:

```
Down Payment at Closing = Purchase Price + Buying Costs - First Mortgage Amount
Committed Capital = Down Payment + (Rehab - amounts covered by loans) + Holding Costs during rehab
Cash on Cash Return = Net Profit / Committed Capital
Annualized CoCR = CoCR × (12 / Hold Months)
Purchase + Rehab ROI = Net Profit / (Purchase + Rehab)
Profit per Month = Net Profit / Hold Time
Cost Per SF = (Purchase + Rehab) / GLA
Projected Sale Date = Today + Total Hold Time
```

### True Profit Formula
```
Net Profit = ARV - Purchase - Rehab - Total Financing (all loans) - Holding - Buying - Selling
Total Costs ROI = Net Profit / Total All-In Cost
Total All-In Cost = Purchase + Rehab + Total Financing + Holding + Buying + Selling
```
